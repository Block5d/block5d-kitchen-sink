...
@Component({
  selector: 'app-project-submission-v2',
  templateUrl: './project-submission-v2.component.html',
  styleUrls: ['./project-submission-v2.component.css']
})
export class ProjectSubmissionV2Component implements OnInit {
